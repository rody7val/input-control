                                      ...
                                      <Row>
                                        <Col>
                                          <FormGroup>
                                            ...
                                            <Input min={0} required onChange={(event) => {this.changeEdit(index, event)}} value={item._qty} type="number" name="_qty" id="qty" placeholder="Cantidad de unidades" />
